...
/* Command for C compiler:
   clang -c  -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib -I/Users/gcao/gene-workspace/gene/tests -o /Users/gcao/gene-workspace/gene/.cache/nim/test_scope_unwind_d/@pstd@senvvars.nim.c.o /Users/gcao/gene-workspace/gene/.cache/nim/test_scope_unwind_d/@pstd@senvvars.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING, getEnvImpl__stdZenvvars_u12)(NCSTRING env_p0) {
	NCSTRING result;
	nimfr_("getEnvImpl", "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, existsEnv__stdZenvvars_u20)(NimStringV2 key_p0) {
	...
	NIM_BOOL T2_;
NIM_BOOL* nimErr_;
	nimfr_("existsEnv", "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	nimlf_(117, "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");	T1_ = (NCSTRING)0;
	T1_ = getEnvImpl__stdZenvvars_u12(nimToCStringConv(key_p0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = (NIM_BOOL)0;
	T2_ = eqeq___system_u8846(T1_, ((NCSTRING) NIM_NIL));
	result = !(T2_);
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getEnv__stdZenvvars_u15)(NimStringV2 key_p0, NimStringV2 default_p1) {
	...
	NCSTRING env_1;
NIM_BOOL* nimErr_;
	nimfr_("getEnv", "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");
{nimErr_ = nimErrorFlag();
	...
	nimln_(100);	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___system_u8846(env_1, ((NCSTRING) NIM_NIL));
		if (!T3_) goto LA4_;
...
LA4_: ;
	{
		nimlf_(103, "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");		result = cstrToNimstr(env_1);
	}
LA1_: ;
	}BeforeRet_: ;
	popFrame();
...
NIM_BOOL* nimErr_;
	nimfr_("putEnv", "/Users/gcao/.nimble/pkgs2/nim-2.2.6-2c9e77a691294dad7472a539f9b78ef0088a1a87/lib/std/envvars.nim");
{nimErr_ = nimErrorFlag();
	nimln_(134);	{
		int T3_;
